...
rc <- readKH("SenatePooledMatrixCivilRightsConstrained.dat", desc="Pooled Matrix, Civil Rights - Constrained")
...
outfile1<-paste("SenatePooledIdealCivilRightsConstrained.dta")

outfile2<-paste("SenatePooledVotesCivilRightsConstrained.dta")

write.dta(estimates1, outfile1)
write.dta(estimates2, outfile2)

wrkspace<-paste("SenatePooledIdealCivilRightsConstrained.RData")
...
output1<-list()
newfinal <-data.frame()
infile <- paste("SenatePooledIdealCivilRightsConstrained.RData", sep="")
load(infile)
...
outfile1<-paste("SenateCongressLevelConstrainedMedians", firstcong, "to", lastcong, ".dta", sep="")
