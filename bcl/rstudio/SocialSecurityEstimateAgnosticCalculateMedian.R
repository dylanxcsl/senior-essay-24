...
rc <- readKH("PooledMatrixSocialSecurityAgnostic.dat", desc="Pooled Matrix, Social Security - Agnostic")
...
outfile1<-paste("PooledIdealSocialSecurityAgnostic.dta")

outfile2<-paste("PooledVotesSocialSecurityAgnostic.dta")

write.dta(estimates1, file = outfile1)
write.dta(estimates2, file = outfile2)

wrkspace<-paste("PooledIdealSocialSecurityAgnostic.RData")
...
infile <- paste("PooledIdealSocialSecurityAgnostic.RData", sep="")
load(infile)
...
outfile1<-paste("SocialSecurityCongressLevelAgnosticMedians", firstcong, "to", lastcong, ".dta", sep="")
